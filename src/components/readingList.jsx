...
export function ReadingList() {
    ...
    return (
        <>
            <label className="text-white bg-cyan-500 block w-8 h-8 justify-center transition-all cursor-pointer z-10 absolute top-20 right-6 py-1 px-1 rounded-full hover:scale-125" htmlFor={realingListChkboxId}>
                <ReadingBookIcon />
            </label>
